---
layout: post
title: PyModPDE, A python software for modified equation analysis
tags: [stabilityanalysis,numericalmethods,PDE]
---

Modified equation analysis like a breeze! 

PyModPDE is a Python software for modified equation analysis, it takes a discrete **PDE** as its input and outputs the modified equation in LaTeX format.
